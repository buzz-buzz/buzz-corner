...
class classDetail extends Component {
    ...
    showZoom() {
        if (this.state.class_info.room_url) {
            ...
            window.location.href = `/zoom-join?zoom_number=${zoom_number}&user_name=${this.state.user_name}&zc=${this.state.class_info.zc || '0'}`;
        } else {
            alert('缺少Zoom教室链接');
        }
    }
                ...
                <div className="class-detail-practice">
                    {
                        ...
                        <div>
                            <div className="class-detail-tab"
                                ...
                                <div
                                    className={this.state.class_content_tab === 'practice' ? "active" : ""}
