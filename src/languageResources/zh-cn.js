...
export const placementQuestion1 = '亲爱的学员，你已经学了多久的英语?';
export const placementQuestion1Answer1 = '没有学过';
export const placementQuestion1Answer2 = '少于一年';
export const placementQuestion1Answer3 = '1-2年';
export const placementQuestion1Answer4 = '2-3年';
export const placementQuestion1Answer5 = '3年以上';
export const placementQuestion2 = '在英语会话过程中，以下哪种描述情况与你相似?';
export const placementQuestion2Answer1 = '需要翻译听懂常用指令,能简短介绍个人和兴趣爱好';
export const placementQuestion2Answer2 = '能听懂常用指令对话并做出反应，能清楚地介绍自己，能简单描述一件事';
export const placementQuestion2Answer3 = '能简单描述一件事或事物';
export const placementQuestion2Answer4 = '能比较有条理地描述个人体验和表达个人想法';
export const placementQuestion3 = '与首次相识的人交流中，你是否是容易或热衷于与人沟通。';
export const placementQuestion3Answer1 = '是的，我就是';
export const placementQuestion3Answer2 = '有时候是';
export const placementQuestion3Answer3 = '完全不是';
export const placementQuestion4 = '挑选2张你善于描述的场景并进行各不少于10秒的描述。';
export const placementQuestion5 = '请根据下图，用英语进行10秒 - 60秒的描述。';
...
export const classEvaluationStarsStatus4 = '很棒';
...
export const profileGender = '性别';
export const profileGenderHolder = '选择';
export const profileBirthday = '生日';
...
export const profileCityOnly = '所在城市';
...
export const myWord = '我的评价:';
export const goNow = '快去评价';
...
export const evaluationTeacherScore = '评分: ';
...
export const accountInputPasswordLogin = '只有你知道哦';
export const accountInputAccount = '手机号/邮箱';
...
export const taoCourseSignInfo = '参加该课程需要扣除$个课时';
